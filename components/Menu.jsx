...
import {BsChevronDown} from "react-icons/bs"   //downarraow 

const data = [
    { id: 1, name: "cloths", url: "/" },
    { id: 2, name: "electronic", url: "/about" },
    { id: 3, name: "grocery", subMenu: true },
    { id: 4, name: "shoes", url: "/contact" },
];
